...
if __name__ == '__main__':
    host = 'pcmdi.llnl.gov'
    username = 'sampsonbryce'
    openid = 'https://pcmdi.llnl.gov/esgf-idp/openid/sampsonbryce'
    password = 'Santacruz1!'
    outfile = os.path.join(os.environ['HOME'], 'test.pem')
    myproxy_logon(host, username, password, outfile, lifetime=20000, port=7512)
    url = 'http://esgf-data1.ceda.ac.uk/thredds/fileServer/esg_dataroot/cmip5/output1/NCAR/CCSM4/piControl/mon/atmos/cfMon/r3i1p1/v20130702/hur/hur_cfMon_CCSM4_piControl_r3i1p1_000101-004012.nc'
    # context = ssl.SSLContext(ssl.PROTOCOL_SSLv23)
    # context.load_verify_locations(cafile=outfile)
    # result = urllib2.urlopen(url, context=context)
    r = requests.get(url, auth=(openid, password))
